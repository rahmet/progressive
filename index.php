		...
		<li data-delay="7000" data-transition="fade" data-slotamount="7" data-masterspeed="2000">
		  <div class="elements">
			<div class="tp-caption lfl"
			  ...
			  style="z-index: 2">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img1.png" width="217" height="172" alt="">
			</div>
			...
			<div class="tp-caption lft"
			  ...
			  data-endspeed="500"
			  data-endeasing="Power1.easeIn">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img2.png" width="71" height="104" alt="">
			</div>
			...
			<div class="tp-caption lfb"
			  ...
			  data-endspeed="500"
			  data-endeasing="Power1.easeIn">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img3.png" width="764" height="76" alt="">
			</div>
			...
			<div class="tp-caption lft"
			  ...
			  data-endspeed="500"
			  data-endeasing="Power1.easeIn">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img4.png" width="247" height="71" alt="">
			</div>
			...
			<div class="tp-caption customin"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 3">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img5.png" width="166" height="107" alt="">
			</div>
			...
			<div class="tp-caption lft"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 1">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img6.png" width="104" height="157" alt="">
			</div>
			...
			<div class="tp-caption lfl"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 3">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img7.png" width="95" height="197" alt="">
			</div>
			...
			<div class="tp-caption lfl lft"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 3">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img8.png" width="275" height="240" alt="">
			</div>
			...
			<div class="tp-caption customin"
			  ...
			  data-endspeed="500"
			  data-endeasing="Power1.easeIn">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img9.png" width="101" height="101" alt="">
			</div>
			...
			<div class="tp-caption lfb"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img10.png" width="64" height="77" alt="">
			</div>
			...
			<div class="tp-caption lfl"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 3">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img11.png" width="35" height="14" alt="">
			</div>
			...
			<div class="tp-caption lfb"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img12.png" width="33" height="25" alt="">
			</div>
			...
			<div class="tp-caption lfb"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img13.png" width="33" height="25" alt="">
			</div>
			...
			<div class="tp-caption lfb"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-img14.png" width="33" height="25" alt="">
			</div>
		  ...
		  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider4-bg.jpg" alt="" data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
		</li>
		...
		<li data-delay="7000" data-transition="fade" data-slotamount="7" data-masterspeed="2000">
		  <div class="elements">
			<div class="tp-caption lfb skewtobottom"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 3">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider1-phone.png" width="375" height="434" alt="">
			</div>
			...
			<div class="tp-caption lfb skewtobottom"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 1">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider1-phone-bg.png" width="160" height="296" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-endspeed="300"
			  style="z-index: 5">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider1-html5-1.png" width="99" height="111" alt="">
			</div>
			...
			<div class="tp-caption customin"
			  ...
			  data-endspeed="400"
			  style="z-index: 5">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider1-html5-2.png" width="72" height="91" alt="">
			</div>
			...
			<div class="tp-caption customin"
			  ...
			  data-endspeed="100"
			  style="z-index: 5">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider1-css3.png" width="72" height="91" alt="">
			</div>
		  ...
		  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider1-bg.jpg" alt="" data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
		</li>
		...
		<li data-delay="10300" data-transition="fade" data-slotamount="7" data-masterspeed="2000" class="slid2">
		  <div class="elements">
			...
			<div class="tp-caption lfb skewtobottom customin"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 3">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-img.png" width="731" height="284" alt="">
			</div>
			...
			<div class="tp-caption lfb customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 2">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-homepage1.png" width="277" height="280" alt="">
			</div>
			...
			<div class="tp-caption lfb customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 2">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-homepage2.png" width="277" height="280" alt="">
			</div>
			...
			<div class="tp-caption lfb customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 2">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-homepage3.png" width="277" height="280" alt="">
			</div>
			...
			<div class="tp-caption lfb customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 2">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-homepage4.png" width="277" height="280" alt="">
			</div>
			...
			<div class="tp-caption  customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-one.png" width="110" height="168" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-two.png" width="110" height="168" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-three.png" width="110" height="168" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-four.png" width="110" height="168" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-quadrate1.png" width="48" height="48" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-quadrate2.png" width="79" height="79" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-quadrate3.png" width="110" height="107" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-quadrate4.png" width="140" height="138" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-quadrate5.png" width="170" height="168" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-quadrate6.png" width="200" height="200" alt="">
			</div>
			...
			<div class="tp-caption customin customout"
			  ...
			  data-captionhidden="on"
			  style="z-index: 4">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-quadrate7.png" width="231" height="231" alt="">
			</div>
		  </div>
		  
		  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider2-bg.jpg" alt="" data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
		</li>
		...
		<li data-delay="8000" data-transition="fade" data-slotamount="7" data-masterspeed="2000">
		  <div class="elements">
			<div class="tp-caption lfl skewtoleft"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 1">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider3-pig.png" width="576" height="393" alt="">
			</div>
			...
			<div class="tp-caption lfl skewtoleft"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 3">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider3-pig2.png" width="576" height="393" alt="">
			</div>
			...
			<div class="tp-caption lft customout"
			  ...
			  data-endeasing="Power1.easeIn"
			  style="z-index: 2">
			  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider3-coin.png" width="64" height="68" alt="">
			</div>
		  ...
		  <img src="<?php echo get_template_directory_uri(); ?>/img/content/slider/rs-slider3-bg.jpg" alt="" data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
		</li>
	  </ul>
...
<div class="banner-set load">
  <div class="container">
	<div class="banners">
	  <a href="#" class="banner">
		<img src="<?php echo get_template_directory_uri(); ?>/img/content/banner1.jpg" width="253" height="158" alt="">
	  ...
	  <a href="#" class="banner">
		<img src="<?php echo get_template_directory_uri(); ?>/img/content/banner2.jpg" width="253" height="158" alt="">
	  ...
	  <a href="#" class="banner">
		<img src="<?php echo get_template_directory_uri(); ?>/img/content/banner3.jpg" width="253" height="158" alt="">
	  ...
	  <a href="#" class="banner">
		<img src="<?php echo get_template_directory_uri(); ?>/img/content/banner4.jpg" width="253" height="158" alt="">
	  ...
	  <a href="#" class="banner">
		<img src="<?php echo get_template_directory_uri(); ?>/img/content/banner5.jpg" width="253" height="158" alt="">
		<h2 class="title">Home Theater</h2>
		<div class="description">Nunc condimentum eros vel nibh consectetur dignissim. Ut ante neque, ullamcorper ac feugiat at, ullamcorper sagittis magna.</div>
	  </a>
	  <a href="#" class="banner">
		<img src="<?php echo get_template_directory_uri(); ?>/img/content/banner6.jpg" width="253" height="158" alt="">
		<h2 class="title">Multiroom</h2>
		<div class="description">Maecenas ac leo velit. Aliquam venenatis tellus in erat pellentesque ut dignissim turpis consequat. Fusce sit amet sagittis urna.</div>
	  </a>
	</div><!-- .banners -->
		  ...
		  <div class="carousel no-responsive gallery">
			<div class="col-sm-4 col-md-3">
			  <a class="gallery-images" rel="fancybox" href="img/content/office-1.jpg">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/office-1-270.jpg" width="270" height="135" alt="">
				<span class="bg-images"><i class="fa fa-search"></i></span>
			  </a>
			</div>
			<div class="col-sm-4 col-md-3">
			  <a class="gallery-images" rel="fancybox" href="img/content/office-2.jpg">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/office-2-270.jpg" width="270" height="135" alt="">
				<span class="bg-images"><i class="fa fa-search"></i></span>
			  </a>
			</div>
			<div class="col-sm-4 col-md-3">
			  <a class="gallery-images" rel="fancybox" href="img/content/office-3.jpg">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/office-3-270.jpg" width="270" height="135" alt="">
				<span class="bg-images"><i class="fa fa-search"></i></span>
			  </a>
			</div>
			<div class="col-sm-4 col-md-3">
			  <a class="gallery-images" rel="fancybox" href="img/content/office-4.jpg">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/office-4-270.jpg" width="270" height="135" alt="">
				<span class="bg-images"><i class="fa fa-search"></i></span>
			  </a>
			</div>
		  </div>
		  ...
		  <div class="row filter-elements">
			<div class="work-element web-design col-xs-12 col-sm-3 col-md-3">
			  <a href="portfolio-single.html" class="work">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/portfolio-1-270.jpg" width="270" height="197" alt="">
			...
			<div class="work-element graphic-design col-xs-12 col-sm-3 col-md-3">
			  <a href="portfolio-single.html" class="work">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/portfolio-2-270.jpg" width="270" height="197" alt="">
				<span class="shadow"></span>
				<div class="bg-hover"></div>
				<div class="work-title">
			...
			<div class="work-element ecommerce col-xs-12 col-sm-3 col-md-3">
			  <a href="portfolio-single.html" class="work">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/portfolio-3-270.jpg" width="270" height="197" alt="">
				<span class="shadow"></span>
				<div class="bg-hover"></div>
				<div class="work-title">
			...
			<div class="work-element graphic-design col-xs-12 col-sm-3 col-md-3">
			  <a href="portfolio-single.html" class="work">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/portfolio-4-270.jpg" width="270" height="197" alt="">
				<span class="shadow"></span>
				<div class="bg-hover"></div>
				<div class="work-title">
			...
			<div class="work-element graphic-design col-xs-12 col-sm-3 col-md-3">
			  <a href="portfolio-single.html" class="work">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/portfolio-5-270.jpg" width="270" height="197" alt="">
				<span class="shadow"></span>
				<div class="bg-hover"></div>
				<div class="work-title">
			...
			<div class="work-element ecommerce col-xs-12 col-sm-3 col-md-3">
			  <a href="portfolio-single.html" class="work">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/portfolio-6-270.jpg" width="270" height="197" alt="">
				<span class="shadow"></span>
				<div class="bg-hover"></div>
				<div class="work-title">
			...
			<div class="work-element ecommerce col-xs-12 col-sm-3 col-md-3">
			  <a href="portfolio-single.html" class="work">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/portfolio-7-270.jpg" width="270" height="197" alt="">
				<span class="shadow"></span>
				<div class="bg-hover"></div>
				<div class="work-title">
			...
			<div class="work-element web-design col-xs-12 col-sm-3 col-md-3">
			  <a href="portfolio-single.html" class="work">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/portfolio-8-270.jpg" width="270" height="197" alt="">
				<span class="shadow"></span>
				<div class="bg-hover"></div>
				<div class="work-title">
		  ...
		  <div class="panel-group multi-collapse" id="accordion2">
			...
			<div class="panel panel-default">
			  ...
			  <div id="collapse23" class="panel-collapse collapse">
				<div class="panel-body">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/animations.png" class="alignleft" width="100" height="62" alt="">
		...
		<div class="row">
		  <div class="carousel products">
			<div class="col-sm-3 col-md-3 product rotation">
			  <div class="default">
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-11.png" alt="" title="" width="270" height="270">
				</a>
			...
			<div class="col-sm-3 col-md-3 product rotation">
			  <div class="default">
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-12.png" alt="" title="" width="270" height="270">
				</a>
				<div class="product-description">
				  <div class="vertical">
				<h3 class="product-name">
			  ...
			  <div class="product-hover">
				...
				<div class="price">$1, 449.00</div>
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-12.png" alt="" title="" width="70" height="70">
				</a>
				<ul>
				  <li>117 cm / 46"LCD TV</li>
				  <li>Full HD 3D &amp; 2D</li>
			...
			<div class="col-sm-3 col-md-3 product rotation">
			  ...
			  <div class="product-hover">
				...
				<div class="price">$1, 449.00</div>
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-13.png" alt="" title="" width="70" height="70">
				</a>
				<ul>
				  <li>117 cm / 46"LCD TV</li>
				  <li>Full HD 3D &amp; 2D</li>
			...
			<div class="col-sm-3 col-md-3 product rotation">
			  ...
			  <div class="product-hover">
				...
				<div class="price">$1, 449.00</div>
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-14.png" alt="" title="" width="70" height="70">
				</a>
				<ul>
				  <li>117 cm / 46"LCD TV</li>
				  <li>Full HD 3D &amp; 2D</li>
			...
			<div class="col-sm-3 col-md-3 product rotation">
			  <div class="default">
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-5.png" alt="" title="" width="270" height="270">
				</a>
				<div class="product-description">
				  <div class="vertical">
				<h3 class="product-name">
			  ...
			  <div class="product-hover">
				...
				<div class="price">$1, 449.00</div>
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-5.png" alt="" title="" width="70" height="70">
				</a>
				<ul>
				  <li>117 cm / 46"LCD TV</li>
				  <li>Full HD 3D &amp; 2D</li>
			...
			<div class="col-sm-3 col-md-3 product rotation">
			  <div class="default">
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-6.png" alt="" title="" width="270" height="270">
				</a>
				<div class="product-description">
				  <div class="vertical">
				<h3 class="product-name">
			  ...
			  <div class="product-hover">
				...
				<div class="price">$1, 449.00</div>
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-6.png" alt="" title="" width="70" height="70">
				</a>
				<ul>
				  <li>117 cm / 46"LCD TV</li>
				  <li>Full HD 3D &amp; 2D</li>
			...
			<div class="col-sm-3 col-md-3 product rotation">
			  <div class="default">
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-7.png" alt="" title="" width="270" height="270">
				</a>
				<div class="product-description">
				  <div class="vertical">
				<h3 class="product-name">
			  ...
			  <div class="product-hover">
				...
				<div class="price">$1, 449.00</div>
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-7.png" alt="" title="" width="70" height="70">
				</a>
				<ul>
				  <li>117 cm / 46"LCD TV</li>
				  <li>Full HD 3D &amp; 2D</li>
			...
			<div class="col-sm-3 col-md-3 product rotation">
			  <div class="default">
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-8.png" alt="" title="" width="270" height="270">
				</a>
				<div class="product-description">
				  <div class="vertical">
				<h3 class="product-name">
			  ...
			  <div class="product-hover">
				...
				<div class="price">$1, 449.00</div>
				<a href="shop-product-view.html" class="product-image">
				  <img src="<?php echo get_template_directory_uri(); ?>/img/content/product-8.png" alt="" title="" width="70" height="70">
				</a>
				<ul>
				  <li>117 cm / 46"LCD TV</li>
				  <li>Full HD 3D &amp; 2D</li>
	  ...
	  <div class="container">
		...
		<div class="row text-center">
		  <div class="col-sm-3 col-md-3 rotation employee">
			<div class="default">
			  <div class="image">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/team-1.jpg" alt="" title="" width="270" height="270">
			  </div>
		  ...
		  --><div class="col-sm-3 col-md-3 rotation employee">
			<div class="default">
			  <div class="image">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/team-2.jpg" alt="" title="" width="270" height="270">
			  </div>
			  <div class="description">
				<div class="vertical">
		  ...
		  --><div class="col-sm-3 col-md-3 rotation employee">
			<div class="default">
			  <div class="image">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/team-3.jpg" alt="" title="" width="270" height="270">
			  </div>
			  <div class="description">
				<div class="vertical">
		  ...
		  --><div class="col-sm-3 col-md-3 rotation employee">
			<div class="default">
			  <div class="image">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/team-4.jpg" alt="" title="" width="270" height="270">
			  </div>
			  <div class="description">
				<div class="vertical">
	  ...
	  <div class="row">
		<div class="col-sm-12 col-md-6 promo-partners bottom-padding">
		  ...
		  <div class="row manufactures manufactures-list">
			<div class="make-wrapper">
			  <a href="#" class="make">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/make-2.png" width="128" height="128" alt="">
			  </a>
			</div><!--
				
			--><div class="make-wrapper">
			  <a href="#" class="make">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/make-3.png" width="128" height="128" alt="">
			  </a>
			</div><!--
				
			--><div class="make-wrapper">
			  <a href="#" class="make">
				<img src="<?php echo get_template_directory_uri(); ?>/img/content/make-4.png" width="128" height="128" alt="">
			  </a>
			</div>
		  </div>
		...
		<div class="col-sm-12 col-md-6">
		  ...
		  <ul class="latest-posts">
			<li>
			  <img class="image img-circle" src="<?php echo get_template_directory_uri(); ?>/img/content/1.gif" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
			  <div class="meta">
